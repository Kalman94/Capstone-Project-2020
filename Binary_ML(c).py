...
dataset=pd.read_csv( "C:\\Users\\User\\Desktop\\Capstone\\1.Code\\Datasets\\Binary.csv", sep=",")
...
clss_pre = setup(data = data, target ='Class',
                 session_id=312, silent=True,
                  ...
                  #feature_interaction=True, #Can't run it because generate 111575
...
#To CSV
#init_m.to_csv(r'C:\\Users\\User\\Desktop\\Capstone\\1.Code\\Datasets\\Produced_Datasets\\Binary_Init_Clf.csv')

#To Excel
from pandas import ExcelWriter

writer = ExcelWriter('C:\\Users\\User\\Desktop\\Capstone\\1.Code\\Datasets\\Produced_Datasets\\Binary_Init_Clf.xlsx')
...
#Radia SVM
plot_model(tuned_rfbsvm, plot = 'auc')
plot_model(tuned_rfbsvm, plot = 'pr')
plot_model(tuned_rfbsvm, plot = 'confusion_matrix')
plot_model(tuned_rfbsvm, plot = 'error')
plot_model(tuned_rfbsvm, plot = 'class_report')
plot_model(tuned_rfbsvm, plot='calibration')
...
stacked = stack_models([tuned_rf, tuned_rfbsvm, tuned_et], meta_model=tuned_et,plot=True)
...
save_model(tuned_et, 't_et_bi_2706')
save_model(tuned_rf, 't_rf_bi_2706')
save_model(stacked, 't_stacked_bi_2706')
save_model(calibrated_et, 't_cal_et_bi_2706')


save_experiment('Binary_2706')
